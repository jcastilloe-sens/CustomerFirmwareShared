...
#ifdef TESTING_MODE
#define STARTING_ERRORS		(MEMORY_FAILED | BATTERY_TOO_LOW)
...
#else
#define STARTING_ERRORS		(MEMORY_FAILED | BATTERY_TOO_LOW | MAX_TESTS_REACHED | MAX_CALS_REACHED | CARTRIDGE_EXPIRED)
