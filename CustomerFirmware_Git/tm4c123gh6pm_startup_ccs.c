...
void (* const g_pfnVectors[])(void) =
{
	...
	CartridgeIntHandler,                      // GPIO Port B
    IntDefaultHandler,                      // GPIO Port C
	IntDefaultHandler,                      // GPIO Port D
	BatteryIntHandler,                      // GPIO Port E
	...
	BatteryIntHandler,                      // Timer 2 subtimer A
	...
	HibernateTimeoutIntHandler,                      // Wide Timer 0 subtimer A
    IntDefaultHandler,                      // Wide Timer 0 subtimer B
	TempRecordTimerIntHandler,                      // Wide Timer 1 subtimer A
